...
search.addEventListener("keyup", (e) => {
  ...
  let content = document.querySelectorAll("h2.title");
  ...
  content.forEach((content) => {
    if (content.textContent.toLowerCase().includes(currentvalue)) {
      content.parentNode.parentNode.style.display = "grid";
    } else {
